...
function Index() {
  ...
  useEffect(() => {
    const handleOutsidePointerDown = (event: PointerEvent) => {
      ...
      const clickedSidebarCard = target?.closest("[data-sidebar-trigger]");
  ...
  return (
    <div className="module-page-enter min-h-screen bg-background text-foreground">
      <header
      ...
      <div className="flex min-h-[calc(100vh-72px)]">
        <aside
          ref={sidebarRef}
          className={`shrink-0 overflow-hidden border-r border-border bg-sidebar pt-6 transition-[width,opacity] duration-800 ease-in-out ${
            sidebarOpen ? "w-[280px] opacity-100" : "w-0 border-r-0 opacity-0"
          }`}
        >
